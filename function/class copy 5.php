...
class DataImport
{
    ...
    public function insert_data($array)
    {
                        ...
                        if ($loan_data) {
                            ...
                            if ($existing_record == 0) {
                                ...
                                if ($stmt_update->rowCount() > 0) {
                                    ...
                                    // If update fails, set balance_update_status to 0 in the loan table
                                ...
                                // Error message if the record already exists for the same loan_id and month
        ...
        // Ensure `balance_update_status` is set properly even if other updates failed
        if (isset($loan_id)) {
            ...
            if ($status !== 1) {
                // Set balance_update_status to 0 if the update did not occur
