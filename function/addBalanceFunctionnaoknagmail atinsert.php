...
function send_notification_email(
    ...
    try {
        ...
        $email_template = "
        <h2 style='color: #333;'>Dear $fname $mname $lname,</h2>
        <h3 style='color: #333;'>We are pleased to inform you that your loan has been successfully added to our system.</h3>
        <p style='color: #333;'>You may log in to your account to monitor your loan balance and view detailed information regarding your loan.</p>
        <p style='color: #333;'>Please find a summary of your loan details below:</p>
        <ul style='color: #333;'>
