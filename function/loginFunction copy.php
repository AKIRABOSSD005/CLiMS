...
function login($emailOrUsername, $password, $conn) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($hashed_password === $stored_hashed_password) {
            ...
            log_activity($user['member_id'], 'Login Successful', $conn);
            ...
            log_activity(0, 'Login Failed - Incorrect Password', $conn);
            
            // Keep the email/username in the session
        ...
        log_activity(0, 'Login Failed - User Not Found', $conn);
