...
<body>
    <div class="wrapper">
        ...
        <div class="main">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="button-container d-flex">
                                    ...
                                    <button id="uploadMembers" name="uploadMembers"
                                        class="upload-loan-button btn btn-primary me-2 mb-2" data-bs-toggle="modal"
                                        data-bs-target="#uploadMemberModal">
                                        <i class="lni lni-upload"></i>
                                        <span class="button-text d-none d-sm-inline">Upload Updated Loan</span>
                                    </button>
                                    <!-- Print Dropdown -->
                                    <a class="print-button btn btn-primary me-2 mb-2" href="#" class="btn btn-primary"
                                        data-bs-toggle="modal" data-bs-target="#prtintModal">
            ...
            <div class="footer-right d-flex justify-content-center align-items-end mt-2 pt-2 fw-bold"
                ...
                <pre
                    class="sidebar-footer-text text-light fw-bold text-center"> A capstone project is design and develop by <a href="developer.php" class="text-decoration-none text-light">TEAM AREA</a></pre>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="prtintModal" tabindex="-1" aria-labelledby="printModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="monthlyForm" action="../function/printFunction.php" enctype="multipart/form-data"
                        ...
                        <div class="modal-footer d-flex justify-content-center align-items-center">
                            <button type="submit" class="btn btn-primary ms-2" name="printReport">Print
                                Report</button>
