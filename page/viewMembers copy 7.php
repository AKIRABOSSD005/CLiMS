...
<body>
                                    ...
                                    <form action="../function/addBalanceFunction.php" method="POST">
                                        ...
                                        <?php
                                            ...
                                            if (isset($_GET['member_id'])) {
                                                ...
                                                $existing_loan_share = "SELECT * FROM loan WHERE member_id = '$member_id'";
                                            ...
                                            $has_share_capital = isset($data['share_capital']) && $data['share_capital'] != 0;
    ...
    <input type="text" 
           ...
           id="share_capital" 
           name="share_capital"
           placeholder="₱<?= number_format($share_capital, 2); ?>" 
           <?= $existing_loan_records ? 'readonly' : '' ?>
           value="<?= $existing_loan_records ? '' : number_format($capitalBuildUpValue, 2); ?>" 
           required 
           oninput="calculateLoanableAmount()" 
           style="border: 1px solid #388e3c; border-radius: 4px; padding: 10px;">
</div>

<input type="text" id="capitalBuildUp" name="capitalBuildUp" value="<?= $capitalBuildUpValue; ?>">
