                    ...
                    <div class="row mt-3" style="padding: 10px 0;">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="principal_amount" name="principal_amount" required
                                onchange="updateInterest()" style="border: 1px solid #388e3c; border-radius: 4px; padding: 10px;">
...
?>
                        <input type="text" class="form-control" id="existing_balance" name="existing_balance"
...
<script>
    function calculateLoanableAmount() {
        ...
        console.log(existingBalance);  // Debugging: Check the value of existingBalance
