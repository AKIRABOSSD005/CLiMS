...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (loanDataExists && loanData) {
        // Check if capitalBuildUp is a valid number
        ...
        if (!isNaN(capitalBuildUpValue)) {
            ...
            // Handle the case where capitalBuildUp is not a valid number
            shareCapitalField.value = '₱0.00';
            capitalBuildUpField.value = '₱0.00';
        }
    } else {
        // No loan data - allow user input
...
function calculateLoanableAmount() {
    ...
    // Add condition to handle when share capital should be read-only
    const condition = capitalBuildUp > 0; // Example condition based on capitalBuildUp

    if (condition) {
        document.getElementById('share_capital').readOnly = true; // Make it read-only
        document.getElementById('share_capital').value = 
        ...
        document.getElementById('share_capital').readOnly = false; // Make it editable
        document.getElementById('share_capital').value = ''; // Clear the value for manual input
    }
